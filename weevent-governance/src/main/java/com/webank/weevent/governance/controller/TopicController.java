...
public class TopicController {
    ...
    public TopicPage getTopis(@RequestBody TopicPageDto topicPageDto) {
        ...
        return topicService.getTopics(topicPageDto.getBrokerId(),topicPageDto.getPageIndex(),topicPageDto.getPageSize());
    }
    ...
    public Boolean open(@RequestBody TopicCreaterDto topicCreaterDto) {
        ...
        return topicService.open(topicCreaterDto.getBrokerId(),topicCreaterDto.getTopic(),topicCreaterDto.getCreater());
    }
