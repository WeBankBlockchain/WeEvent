...
public class GovernanceException_bak extends Exception {
     ...
     */
    public GovernanceException_bak(String message, Throwable cause) {
     ...
     * @param message the message
     */
    public GovernanceException_bak(String message) {
     ...
     */
    public GovernanceException_bak(ErrorCode errorCode) {
     ...
     */
    public GovernanceException_bak(int code, String message) {
        super(message);
        this.code = code;
        this.message = message;
    }
