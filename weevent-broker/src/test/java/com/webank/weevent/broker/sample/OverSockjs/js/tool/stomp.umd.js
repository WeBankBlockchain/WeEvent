      ...
      /***/ (function (module, exports, __webpack_require__) {
          ...
          var Stomp = /** @class */ (function () {
              ...
              Stomp.over = function (ws) {
                  var wsFn = typeof (ws) === 'function' ? ws : function () {
                      return ws;
                  };
                  return new compat_client_1.CompatClient(wsFn);
              };
      ...
      /***/ (function (module, exports, __webpack_require__) {
          ...
          var FrameImpl = /** @class */ (function () {
              ...
              function FrameImpl(params) {
                  var command = params.command, headers = params.headers, body = params.body,
                      binaryBody = params.binaryBody, escapeHeaderValues = params.escapeHeaderValues,
      ...
      /***/ (function (module, exports, __webpack_require__) {
          ...
          var StompHandler = /** @class */ (function () {
              ...
              StompHandler.prototype._transmit = function (params) {
                  var command = params.command, headers = params.headers, body = params.body,
                      binaryBody = params.binaryBody, skipContentLengthHeader = params.skipContentLengthHeader;
              ...
              StompHandler.prototype.publish = function (params) {
                  var destination = params.destination, headers = params.headers, body = params.body,
                      binaryBody = params.binaryBody, skipContentLengthHeader = params.skipContentLengthHeader;
