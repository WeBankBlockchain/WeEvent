...
function connect() {
    ...
    stompClient.connect(login, passcode, function (frame) {
        ...
        // 通过rest 连接open
        var url = $("#urlparam");
        fetch('http://localhost:8080/weevent/rest/open?topic=com.weevent.test.matthew', {
            method: 'POST',
            headers: {
        ...
        // fetch('http://127.0.0.1/weevent/rest/open?topic=com.weevent.test.matthew', {
        //     method: 'POST',
        //     headers: {
        //         'Content-Type': 'application/json',
        //     },
        //     body: '{"com.weevent.test.matthew"}',
        // }).then(function (response) {
        //     //change the css
        //     if (response.ok) {
        //         $("#sendBox").show();
