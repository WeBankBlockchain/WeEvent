...
public interface IConsumer extends IEventTopic {
     ...
     */
    Map<String, String> subscribe(Map<String, String> topics, String interfaceType, Long groupId, ConsumerListener listener) throws BrokerException;
     ...
     */
    String subscribe(String topic, String offset, String interfaceType, Long groupId, ConsumerListener listener) throws BrokerException;
     ...
     * @throws BrokerException invalid input param
     */
    String subscribe(String topic, String offset, String subscriptionId, String interfaceType, Long groupId, ConsumerListener listener) throws BrokerException;
